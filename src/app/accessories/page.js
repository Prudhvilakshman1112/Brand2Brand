...
export default function AccessoriesPage() {
  ...
  const menWatches = products.filter(p => p.category === 'accessories' && p.subcategory === 'watches' && p.gender === 'men');
  const womenWatches = products.filter(p => p.category === 'accessories' && p.subcategory === 'watches' && p.gender === 'women');
  const bags = getProductsBySubcategory('accessories', 'bags');
